...
const ExcelHandler = {
  ...
  transformData(rawData) {
    ...
    var headerMap = {
      ...
      '父亲身高': 'fatherHeight',
      '父亲身高(cm)': 'fatherHeight',
      '母亲身高': 'motherHeight',
      '母亲身高(cm)': 'motherHeight',
      '评估日期': 'reportDate',
      '测量日期': 'reportDate',
      // D1 深度睡眠
...
function downloadTemplate() {
  ...
  var template = [
    ['评估编号', '儿童姓名', '性别', '出生日期', '身高(cm)', '体重(kg)', '评估日期', '年增长速率(cm/年)',
     '父亲身高(cm)', '母亲身高(cm)',
     // D1 深度睡眠
    ...
    ['YCAS-2025-001', '张小萌', '女', '2016-03-15', 128.5, 26.8, '2025-02-11', 5.5,
     175, 162,
     '无', '0次', '无', '充沛', '21:30', '07:00', 9.5,
     '中度', '不规律', '经常', '偶尔不吃', 500, '否',
     '3-4次/周', '40-60%', '30-45分钟', '中等', '跳绳, 跑步',
     '偶尔', '好', '无变化', '高', '和谐', '合理', '低'],
    ['YCAS-2025-002', '王小明', '男', '2015-08-20', 135.0, 30.2, '2025-02-11', 6.0,
     178, 165,
